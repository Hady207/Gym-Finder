...
const FinderIntrest = () => {
  return (
    <div className="finder__q3">
      <h1 className="finder__title">What interst you the most</h1>
      ...
      <div className="finder__typeofworkout finder__typeofworkout--staff">
        ...
        <h4 className="choice__description choice__description--staff">
          <span className="choice__description--span staff__description--span-1">
            Staff
          </span>
          <span classname="choice__description--span staff__description--span-2">
      ...
      <div className="finder__typeofworkout finder__typeofworkout--equipment">
        ...
        <h4 className="choice__description choice__description--equipment">
          <span className="choice__description--span equipment__description--span-1">
            Equipment
          </span>
          <span classname="choice__description--span equipment__description--span-2">
      ...
      <div className="finder__typeofworkout finder__typeofworkout--both">
        ...
        <h4 className="choice__description choice__description--both">
          <span className="choice__description--span both__description--span-1">
            Both
          </span>
          <span classname="choice__description--span both__description--span-2">
